          ...
          <div className="grid lg:grid-cols-[minmax(0,1.55fr)_minmax(300px,0.72fr)] gap-9 lg:gap-12 items-start">
            <div>
              <div className="flex items-end justify-between gap-5 border-b-2 border-emerald-950 pb-3">
                <div>
                  <h1 className="font-heading text-2xl sm:text-3xl font-bold text-emerald-950">Shop by department</h1>
                  <p className="mt-1 text-xs sm:text-sm text-slate-600">Current Amazon deals, all at least 15% off and recently checked.</p>
                </div>
              ...
              <div className="grid sm:grid-cols-2 border-b border-emerald-950/15">
                {categories.map((category, index) => (
                  <Link
                    ...
                    className={`group flex items-center justify-between gap-4 py-3.5 border-b border-emerald-950/10 ${index % 2 === 0 ? 'sm:pr-6 sm:border-r' : 'sm:pl-6'}`}
                  >
                    <span className="text-[15px] sm:text-base font-bold text-emerald-950 group-hover:translate-x-0.5 transition-transform">{category.name}</span>
                ...
                <Link to="/?category=all" className="sm:col-span-2 flex items-center justify-between gap-4 py-4 font-black text-emerald-950">
            ...
            <aside className="lg:border-l lg:border-emerald-950/20 lg:pl-7">
              <div className="border-b-2 border-emerald-950 pb-3">
                <div className="ds-kicker">30%+ verified drops</div>
                <h2 className="font-heading text-xl sm:text-2xl font-bold text-emerald-950 mt-1">Standout deals</h2>
              </div>
