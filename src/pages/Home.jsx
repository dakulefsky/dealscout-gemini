...
export default function Home() {
  ...
  const dropDeals = useMemo(() => hasActiveFilters ? [] : balancedFeatured(freshDealDrop(visibleDeals, initialSeenDrop, 8), 8), [visibleDeals, initialSeenDrop, hasActiveFilters]);
