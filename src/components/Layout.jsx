...
import { LogOut, Settings, Heart, Search, X, Loader2, Menu, Bell } from 'lucide-react';
        ...
        <div className="ds-shell">
          <div className="h-16 sm:h-[72px] flex items-center gap-3 sm:gap-6">
            ...
            <nav className="ml-auto flex items-center gap-1 sm:gap-4">
              ...
              <Link to="/?category=all" className="hidden lg:inline-flex items-center gap-2 rounded-md bg-emerald-950 text-white px-4 py-2.5 text-xs font-bold hover:bg-emerald-900"><Bell className="h-3.5 w-3.5" /> Get Deal Alerts</Link>
              <button type="button" className="lg:hidden inline-flex items-center justify-center w-9 h-9 text-slate-700" aria-label="Menu"><Menu className="h-5 w-5" /></button>
            </nav>
          </div>
